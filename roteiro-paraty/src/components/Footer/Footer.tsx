...
export const Footer = () => {
  return (
    <footer
      id="contato"
      className="w-full mt-7 p-7 bg-black bg-opacity-50 overflow-auto ">
      <div className="overflow-auto max-w-md m-auto">
        ...
        <ol className="text-white justify-center grid">
          ...
          <li className="mb-4 hover:text-black py-1 px-3 rounded-full cursor-pointer hover:bg-[#0CC0DF]">
            <Link
              href="https://api.whatsapp.com/send?phone=5524992779411&text=Vim%20do%20Site%20e%20cliquei%20em%20WhatsApp%20no%20Rodapé."
              target="_blank"
              className="flex items-center">
          ...
          <li className="mb-4 hover:text-black pb-0 text-center py-1 px-3 rounded-full cursor-pointer hover:bg-[#0CC0DF]">
            <Link
              href="mailto:seuroteiroemparaty@gmail.com"
              target="_blank"
      ...
      <div className="overflow-auto max-w-md m-auto text-center pt-4 text-white border-t border-double border-t-white">
        <Link
          ...
          className="inline-block hover:text-black py-1 px-3 rounded-full cursor-pointer hover:bg-[#0CC0DF]">
      ...
      <div className="overflow-auto max-w-md m-auto text-center mt-4 pt-4 text-white border-t border-double border-t-white">
        <Link
          href="https://cadastur.turismo.gov.br/cadastur/#!/public/qrcode/47072440000118"
          target="_blank">
          <div>
            <Image
      ...
      <div className="overflow-auto max-w-md m-auto text-center mt-4 pt-4 text-white border-t border-double border-t-white">
        <Link
          id="link-brain-tech"
          href="https://api.whatsapp.com/send?phone=5524992681490&text=Vim%20do%20Site%20Seu%20Roteiro%20em%20Paraty%20e%20gostaria%20de%20fazer%20um%20orçamento."
          target="_blank"
          className="hover:animate-bounce inline-block text-white px-3 rounded">
          Desenvolvido por
          <Image
