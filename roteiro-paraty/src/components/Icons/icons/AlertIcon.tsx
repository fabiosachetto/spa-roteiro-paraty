export const AlertIcon = ({ color = "currentColor", className = "float-left" }) => {
  return (
    <svg fill={color} baseProfile="tiny" height="24px" id="alert-icon" version="1.2" viewBox="0 0 24 24" width="24px" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className={className}>
      <g>
