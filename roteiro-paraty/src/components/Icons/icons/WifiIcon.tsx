export const WifiIcon = ({ color = "currentColor", className = "float-left" }) => {
  return (
    <svg fill={color} className={className} height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
