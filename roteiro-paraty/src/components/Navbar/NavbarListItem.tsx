...
export const NavbarListItem = ({ children, className, ...props }: NavbarListItemProps) => {
  return (
    <span className={cn("mx-1 sm:self-center lg:text-center transition delay-150 duration-300 ease-in-out font-bold pt-1 pb-1 px-4 xl:pt-2 2xl:pt-0 rounded-full cursor-pointer hover:bg-[#0CC0DF]", className)} {...props} >
