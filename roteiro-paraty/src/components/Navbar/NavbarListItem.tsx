...
export const NavbarListItem = ({ children, className, ...props }: NavbarListItemProps) => {
  return (
    <span className={cn("mx-1 transition delay-150 duration-300 ease-in-out font-bold py-1 px-4 sm:pt-6 lg:pt-6 xl:pt-7 2xl:pt-0 rounded-full cursor-pointer hover:bg-[#0CC0DF]", className)} {...props} >
