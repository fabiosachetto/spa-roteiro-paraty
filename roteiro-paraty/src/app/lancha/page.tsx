  ...
  return (
    <section className="mt-7 p-7 text-black bg-white">
      <div>
        ...
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o SEU ROTEIRO EM PARATY oferece no site e com caráter enunciativo, mas não limitativo:</p>
        <ul>
          ...
          <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do SEU ROTEIRO EM PARATY, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
        </ul>
        ...
        <ul>
          <li> <Link target="_blank" href="https://support.google.com/accounts/answer/61416?hl=en"> Google Chrome </Link> </li>
          <li> <Link target="_blank" href="https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop?redirectlocale=en-US&amp;redirectslug=enable-and-disable-cookies-website-preferences"> Firefox </Link> </li>
          <li> <Link target="_blank" href="https://support.microsoft.com/pt-br/help/17442/windows-internet-explorer-delete-manage-cookies"> Microsoft Edge </Link> </li>
          <li> <Link target="_blank" href="https://blogs.opera.com/news/2015/08/how-to-manage-cookies-in-opera/"> Opera </Link> </li>
          <li> <Link target="_blank" href="https://support.apple.com/pt-br/guide/safari/sfri11471/mac"> Safari </Link> </li>
        </ul>
        <h3>Mais informações</h3>
        <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p>
        <p>Esta política é efetiva a partir de <strong>Dec</strong>/<strong>2024</strong>.</p>
      </div>
    </section>
  );
};