  ...
  return (
    ...
    <section id="van" className="mt-7 pt-7 text-white text-center">
      ...
      <div className="pb-7">
        ...
        <p><strong>Início:</strong> 10h | <strong>Retorno:</strong> 16h</p>

        <p className="mb-6"><strong>O embarque e desembarque é realizado na hospedagem do cliente. O almoço ocorre no Restaurante Nascer do Sol na Praia dos Ranchos.</strong></p>

        <p><strong>Valor:</strong> R$150 por pessoa.</p>
        <p><strong>OBS: (Poderão ser cobradas tarifas adicionais para translado de bote para as Piscinas Naturais.)</strong></p>
