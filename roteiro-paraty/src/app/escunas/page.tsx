...
export default function Escunas() {
  return (
    <section id="escuna" className="mt-7 p-7 text-white text-center">
      ...
      {infosEscunas.map((infoEscuna) => {
        return (
          <div key={infoEscuna.titulo} className="pt-7 py-7 border-b border-double border-b-amber-900">
            ...
            <p className="mb-6 inline-block">
              ...
              <strong className="float-left contents">{infoEscuna.alerta}</strong>
            </p>
      ...
      <div className="pt-7 border-t border-double border-t-amber-900">
        ...
        <div className="mt-5">
          <Link href="https://api.whatsapp.com/send?phone=5524998793280&text=Olá,%20vim%20do%20site%20e%20tenho%20interesse%20no%20passeio%20de%20Escuna:%20Vespertino." target="_blank" className="transition delay-150 duration-300 ease-in-out uppercase font-bold py-2 px-12 rounded-full cursor-pointer bg-[#0CC0DF] hover:bg-blue-500">
            Reserve já!
          </Link>
        </div>
      </div> */}
